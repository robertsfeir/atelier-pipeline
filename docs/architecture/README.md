...
| [ADR-0038](ADR-0038-worktree-per-session.md) | Worktree-Per-Session Pipeline Isolation | Accepted | |
| [ADR-0039](ADR-0039-frontend-physics-policy.md) | Frontend Layout Physics -- Pipeline Policy | Accepted | |
| [ADR-0040](ADR-0040-design-system-loading.md) | Design System Auto-Loading | Accepted | |
