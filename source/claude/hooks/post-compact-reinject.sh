...
echo "- Mechanical capture: brain-extractor SubagentStop hook fires after sarah/colby/agatha/robert/robert-spec/sable/sable-ux/ellis and captures decisions/patterns/lessons automatically."
