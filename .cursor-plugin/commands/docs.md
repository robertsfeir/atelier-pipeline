...
feature needs, create a doc plan, and hand it off so Sarah can incorporate it
...
<required-reading>
- `.cursor/references/dor-dod.md` -- DoR/DoD framework
...
deprecations. Sarah should reference this in the ADR's Documentation Impact
