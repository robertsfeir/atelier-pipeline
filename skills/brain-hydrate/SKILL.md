...
| Retro lessons | `cat .claude/references/retro-lessons.md` or `cat templates/references/retro-lessons.md` | Number of lessons |
...
Read `.claude/references/retro-lessons.md` (or `templates/references/retro-lessons.md`). Extract each lesson:
